<template>
    <div class="form-area card border p-2">
        ...
        <div class="mb-3">
            ...
            <input type="text" v-model="userData.url" class="form-control" id="url" rows="3" placeholder="https://..."/>
        </div>
        <div class="mb-3">
            <label for="description" class="form-label">Açıklama</label>
            <textarea class="form-control" v-model="userData.description" id="description" rows="3" placeholder="Bu ne ya..."></textarea>
        </div>
